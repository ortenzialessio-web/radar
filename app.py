...
# Definizione corretta degli 8 portafogli (Incluso KT)
PORTFOLIOS = {
    "📊 COMPARA": [], 
...
def fetch_financial_data(all_tickers):
    ...
    try:
        # Scarichiamo tutti i ticker contemporaneamente: azzera i rifiuti di connessione (429 Rate Limit)
        bulk_data = yf.download(all_tickers, start=start_date, group_by='ticker', auto_adjust=True, progress=False)
        
        for ticker in all_tickers:
            # Estrazione corretto sotto-dataframe per ticker singolo
